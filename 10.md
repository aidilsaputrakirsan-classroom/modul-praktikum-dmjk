...
- **📝 Berkas yang Dikumpulkan**:
  1. **File Packet Tracer** (.pkt): Topologi lengkap dengan konfigurasi
  2. **Dokumentasi Konfigurasi** (.pdf): Konfigurasi Router dan PC
  3. **Dokumentasi Pengujian** (.pdf): Uji konektivitas
  4. **Laporan Praktikum Lengkap** (.pdf)
